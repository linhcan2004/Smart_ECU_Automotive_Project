...
int main(void)
{
  ...
  // 1. Kích hoạt Driver phần cứng thô ban đầu
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, GPIO_PIN_SET); //  TB6612
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_13, GPIO_PIN_SET); // Bật LED hồng ngoại QTR
  ...
  // 3. BẬT NHÂN ĐIỀU PHỐI HỆ ĐIỀU HÀNH FreeRTOS
  osKernelStart();
  /* USER CODE END 2 */
